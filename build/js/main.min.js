...
/* harmony import */ var _modules_accordion_spoller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordion/spoller */ "./js/modules/accordion/spoller.js");
/* harmony import */ var _modules_toggle_toggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/toggle/toggle */ "./js/modules/toggle/toggle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion_spoller__WEBPACK_IMPORTED_MODULE_3__["initAccordeons"])();
  Object(_modules_toggle_toggle__WEBPACK_IMPORTED_MODULE_4__["initCompanyTogglers"])();
...
/*!*****************************************!*\
  !*** ./js/modules/accordion/spoller.js ***!
  \*****************************************/
/*! exports provided: initAccordeons */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAccordeons", function() { return initAccordeons; });
var initAccordeons = function initAccordeons() {
  var items = document.querySelectorAll('.accordion');
  items.forEach(function (accordion) {
    var title = accordion.querySelector('.accordion__title');
    ...
    title.addEventListener('click', function () {
      if (accordion.classList.contains(activeCls)) {
        ...
        items.forEach(function (item) {
          return item.classList.remove(activeCls);
        });
...
/*!*************************************!*\
  !*** ./js/modules/toggle/toggle.js ***!
  \*************************************/
/*! exports provided: initCompanyTogglers */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCompanyTogglers", function() { return initCompanyTogglers; });
var initCompanyTogglers = function initCompanyTogglers() {
  var companyElements = document.querySelectorAll('.company');
  companyElements.forEach(function (element) {
    var button = element.querySelector('.company__toggle');
    var content = element.querySelector('.company__content');
